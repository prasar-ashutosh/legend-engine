...
public class MilestoningMapper
{
    ...
    /*
    Mapper from Persistence model to Milestoning object
     */
    public static Milestoning from(Persistence persistence, Dataset mainDataSet,
                                   Dataset stagingDataset) throws Exception
    {
        ...
        if (mode != null)
        {
            milestoning = extract(mode, mainDataSet, stagingDataset);
        }
        return milestoning;
    }
    ...
    private static Milestoning extract(IngestMode ingestMode, Dataset mainDataSet,
                                       Dataset stagingDataset) throws Exception
    {
