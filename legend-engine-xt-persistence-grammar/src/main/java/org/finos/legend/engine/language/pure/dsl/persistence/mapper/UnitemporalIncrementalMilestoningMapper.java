...
public class UnitemporalIncrementalMilestoningMapper
{
    ...
    {
        DeleteIndicator deleteIndicator = MilestoningMapper.extractDeleteIndicator(unitemporalDelta.mergeStrategy);
        TransactionMilestoningDetails txMilestoningDetails = MilestoningMapper.extractTransactionMilestoningDetails(unitemporalDelta.transactionMilestoning);
